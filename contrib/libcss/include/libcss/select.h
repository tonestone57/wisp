...
typedef enum css_pseudo_element {
    ...
    CSS_PSEUDO_ELEMENT_BACKDROP = 5,
    CSS_PSEUDO_ELEMENT_FILE_SELECTOR_BUTTON = 6,
    CSS_PSEUDO_ELEMENT_PLACEHOLDER = 7,
    CSS_PSEUDO_ELEMENT_MARKER = 8,
    CSS_PSEUDO_ELEMENT_WEBKIT_SEARCH_DECORATION = 9,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATE_AND_TIME_VALUE = 10,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT = 11,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_FIELDS_WRAPPER = 12,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_YEAR_FIELD = 13,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_MONTH_FIELD = 14,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_DAY_FIELD = 15,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_HOUR_FIELD = 16,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_MINUTE_FIELD = 17,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_SECOND_FIELD = 18,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_MILLISECOND_FIELD = 19,
    CSS_PSEUDO_ELEMENT_WEBKIT_DATETIME_EDIT_MERIDIEM_FIELD = 20,
    CSS_PSEUDO_ELEMENT_WEBKIT_CALENDAR_PICKER_INDICATOR = 21,
    CSS_PSEUDO_ELEMENT_WEBKIT_INNER_SPIN_BUTTON = 22,
    CSS_PSEUDO_ELEMENT_WEBKIT_OUTER_SPIN_BUTTON = 23,
    CSS_PSEUDO_ELEMENT_WEBKIT_SCROLLBAR = 24,

    CSS_PSEUDO_ELEMENT_COUNT = 25 /**< Number of pseudo elements */
} css_pseudo_element;
