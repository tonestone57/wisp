...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_LABEL_ELEMENT}, DOM_HTML_LABEL_ELEMENT_PROTECT_VTABLE};
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_label_element_get_form(dom_html_label_element *label, dom_html_form_element **form)
{
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_label_element_get_##attr(dom_html_label_element *element, dom_string **attr)                \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_label_element_set_##attr(dom_html_label_element *element, dom_string *attr)                 \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
