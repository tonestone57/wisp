...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_FRAME_ELEMENT}, DOM_HTML_FRAME_ELEMENT_PROTECT_VTABLE};
...
{
    return dom_html_element_get_bool_property(&ele->base, "noresize", SLEN("noresize"), no_resize);
}
...
{
    return dom_html_element_set_bool_property(&ele->base, "noresize", SLEN("noresize"), no_resize);
}
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_frame_element_get_##attr(dom_html_frame_element *element, dom_string **attr)                \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_frame_element_set_##attr(dom_html_frame_element *element, dom_string *attr)                 \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
