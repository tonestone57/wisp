...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_div_element_get_##attr(dom_html_div_element *element, dom_string **attr)                    \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_div_element_set_##attr(dom_html_div_element *element, dom_string *attr)                     \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
