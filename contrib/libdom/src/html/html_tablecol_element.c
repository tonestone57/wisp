...
{
    return dom_html_element_get_int32_t_property(&table_col->base, "span", SLEN("span"), span);
}
...
{
    return dom_html_element_set_int32_t_property(&table_col->base, "span", SLEN("span"), span);
}
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_table_col_element_get_##attr(dom_html_table_col_element *element, dom_string **attr)        \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_table_col_element_set_##attr(dom_html_table_col_element *element, dom_string *attr)         \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
