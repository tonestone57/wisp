...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_U_LIST_ELEMENT}, DOM_HTML_U_LIST_ELEMENT_PROTECT_VTABLE};
 ...
 */
dom_exception dom_html_u_list_element_get_compact(dom_html_u_list_element *u_list, bool *compact)
{
    return dom_html_element_get_bool_property(&u_list->base, "compact", SLEN("compact"), compact);
}
 ...
 * \param u_list	The dom_html_u_list_element object
 */
dom_exception dom_html_u_list_element_set_compact(dom_html_u_list_element *u_list, bool compact)
{
    return dom_html_element_set_bool_property(&u_list->base, "compact", SLEN("compact"), compact);
}
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_u_list_element_get_##attr(dom_html_u_list_element *element, dom_string **attr)              \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_u_list_element_set_##attr(dom_html_u_list_element *element, dom_string *attr)               \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
