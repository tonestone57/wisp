...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_OPT_GROUP_ELEMENT}, DOM_HTML_OPT_GROUP_ELEMENT_PROTECT_VTABLE};
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_opt_group_element_get_disabled(dom_html_opt_group_element *ele, bool *disabled)
{
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_opt_group_element_set_disabled(dom_html_opt_group_element *ele, bool disabled)
{
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_opt_group_element_get_##attr(dom_html_opt_group_element *element, dom_string **attr)        \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_opt_group_element_set_##attr(dom_html_opt_group_element *element, dom_string *attr)         \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
