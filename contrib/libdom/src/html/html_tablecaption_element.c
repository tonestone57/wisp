...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_TABLE_CAPTION_ELEMENT}, DOM_HTML_TABLE_CAPTION_ELEMENT_PROTECT_VTABLE};
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_table_caption_element_set_##attr(dom_html_table_caption_element *element, dom_string *attr) \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
