...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_HR_ELEMENT}, DOM_HTML_HR_ELEMENT_PROTECT_VTABLE};
...
{
    return dom_html_element_get_bool_property(&ele->base, "noshade", SLEN("noshade"), no_shade);
}
...
{
    return dom_html_element_set_bool_property(&ele->base, "noshade", SLEN("noshade"), no_shade);
}
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_hr_element_get_##attr(dom_html_hr_element *element, dom_string **attr)                      \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_hr_element_set_##attr(dom_html_hr_element *element, dom_string *attr)                       \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
