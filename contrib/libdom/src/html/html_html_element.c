 ...
 */
dom_exception
_dom_html_html_element_create(struct dom_html_element_create_params *params, struct dom_html_html_element **ele)
{
 ...
 */
dom_exception
_dom_html_html_element_initialise(struct dom_html_element_create_params *params, struct dom_html_html_element *ele)
{
 ...
 * for detail */
dom_exception
_dom_html_html_element_parse_attribute(dom_element *ele, dom_string *name, dom_string *value, dom_string **parsed)
{
    UNUSED(ele);
    UNUSED(name);
...
dom_exception _dom_html_html_element_copy_internal(dom_html_html_element *old, dom_html_html_element *new)
{
    dom_exception err;
...
dom_exception dom_html_html_element_get_version(dom_html_html_element *element, dom_string **version)
{
    dom_exception ret;
    dom_string *_memo_version;

    _memo_version = ((struct dom_html_document *)((struct dom_node_internal *)element)->owner)->memoised[hds_version];
...
dom_exception dom_html_html_element_set_version(dom_html_html_element *element, dom_string *version)
{
    dom_exception ret;
    dom_string *_memo_version;
