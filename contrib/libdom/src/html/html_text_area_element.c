...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_TEXT_AREA_ELEMENT}, DOM_HTML_TEXT_AREA_ELEMENT_PROTECT_VTABLE};
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_get_disabled(dom_html_text_area_element *ele, bool *disabled)
{
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_set_disabled(dom_html_text_area_element *ele, bool disabled)
{
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_get_read_only(dom_html_text_area_element *ele, bool *read_only)
{
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_set_read_only(dom_html_text_area_element *ele, bool read_only)
{
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_get_default_value(dom_html_text_area_element *ele, dom_string **default_value)
{
    dom_exception err;

    if (ele->default_value_set == false) {
        err = dom_node_get_text_content((dom_node *)ele, &ele->default_value);
        if (err == DOM_NO_ERR) {
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_set_default_value(dom_html_text_area_element *ele, dom_string *default_value)
{
    if (ele->default_value != NULL)
        dom_string_unref(ele->default_value);
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_get_value(dom_html_text_area_element *ele, dom_string **value)
{
    dom_exception err;
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_text_area_element_set_value(dom_html_text_area_element *ele, dom_string *value)
{
    dom_exception err;
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_text_area_element_get_##attr(dom_html_text_area_element *element, dom_string **attr)        \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_text_area_element_set_##attr(dom_html_text_area_element *element, dom_string *attr)         \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
...
{
    dom_html_document *html = (dom_html_document *)((dom_node_internal *)text_area)->owner;
...
dom_exception dom_html_text_area_element_blur(dom_html_text_area_element *ele)
{
    ...
    return _dom_dispatch_generic_event(
        (dom_document *)doc, (dom_event_target *)ele, doc->memoised[hds_blur], false, false, &success);
}
