...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_LI_ELEMENT}, DOM_HTML_LI_ELEMENT_PROTECT_VTABLE};
 ...
 */
dom_exception dom_html_li_element_get_value(dom_html_li_element *li, dom_long *value)
{
    return dom_html_element_get_int32_t_property(&li->base, "value", SLEN("value"), value);
}
 ...
 * \param li	The dom_html_li_element object
 */
dom_exception dom_html_li_element_set_value(dom_html_li_element *li, dom_long value)
{
    return dom_html_element_set_int32_t_property(&li->base, "value", SLEN("value"), value);
}
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_li_element_get_##attr(dom_html_li_element *element, dom_string **attr)                      \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_li_element_set_##attr(dom_html_li_element *element, dom_string *attr)                       \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
