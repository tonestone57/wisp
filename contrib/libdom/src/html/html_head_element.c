...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_HEAD_ELEMENT}, DOM_HTML_HEAD_ELEMENT_PROTECT_VTABLE};
...
dom_exception dom_html_head_element_get_profile(dom_html_head_element *element, dom_string **profile)
{
    ...
    _memo_profile = ((struct dom_html_document *)((struct dom_node_internal *)element)->owner)->memoised[hds_profile];
