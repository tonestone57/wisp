 ...
 */
dom_exception dom_html_base_font_element_get_size(dom_html_base_font_element *base_font, int32_t *size)
{
    return dom_html_element_get_int32_t_property(&base_font->base, "size", SLEN("size"), size);
}
 ...
 * \param base_font	The dom_html_base_font_element object
 */
dom_exception dom_html_base_font_element_set_size(dom_html_base_font_element *base_font, uint32_t size)
{
    return dom_html_element_set_int32_t_property(&base_font->base, "size", SLEN("size"), size);
}
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_base_font_element_get_##attr(dom_html_base_font_element *element, dom_string **attr)        \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_base_font_element_set_##attr(dom_html_base_font_element *element, dom_string *attr)         \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
