...
{
    return dom_html_element_get_bool_property(&ele->base, "nohref", SLEN("nohref"), no_href);
}
...
{
    return dom_html_element_set_bool_property(&ele->base, "nohref", SLEN("nohref"), no_href);
}
...
{
    return dom_html_element_get_int32_t_property(&area->base, "tabindex", SLEN("tabindex"), tab_index);
}
...
{
    return dom_html_element_set_int32_t_property(&area->base, "tabindex", SLEN("tabindex"), tab_index);
}
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_area_element_get_##attr(dom_html_area_element *element, dom_string **attr)                  \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_area_element_set_##attr(dom_html_area_element *element, dom_string *attr)                   \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
