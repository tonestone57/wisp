...
static const struct dom_element_protected_vtable _protect_vtable = {
    {DOM_NODE_PROTECT_VTABLE_HTML_LEGEND_ELEMENT}, DOM_HTML_LEGEND_ELEMENT_PROTECT_VTABLE};
 ...
 * \return DOM_NO_ERR on success, appropriate dom_exception on failure.
 */
dom_exception dom_html_legend_element_get_form(dom_html_legend_element *legend, dom_html_form_element **form)
{
    ...
    while (field_set != NULL) {
        if (field_set->type == DOM_ELEMENT_NODE &&
            dom_string_caseless_isequal(field_set->name, doc->elements[DOM_HTML_ELEMENT_TYPE_FIELDSET]))
            break;
    ...
    if (field_set != NULL) {
        return dom_html_field_set_element_get_form((dom_html_field_set_element *)field_set, form);
    }
...
#define SIMPLE_GET(attr)                                                                                               \
    dom_exception dom_html_legend_element_get_##attr(dom_html_legend_element *element, dom_string **attr)              \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
...
#define SIMPLE_SET(attr)                                                                                               \
    dom_exception dom_html_legend_element_set_##attr(dom_html_legend_element *element, dom_string *attr)               \
    {                                                                                                                  \
        dom_exception ret;                                                                                             \
        dom_string *_memo_##attr;                                                                                      \
                                                                                                                       \
...
dom_exception dom_html_legend_element_get_align(dom_html_legend_element *legend, dom_string **align)
{
    dom_exception err;
    dom_html_document *doc = (dom_html_document *)((dom_node_internal *)legend)->owner;
