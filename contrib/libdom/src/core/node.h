...
dom_exception _dom_node_initialise(struct dom_node_internal *node, struct dom_document *doc, dom_node_type type,
...
#define DOM_NODE_EVENT_TARGET_VTABLE                                                                                   \
    _dom_node_add_event_listener, _dom_node_remove_event_listener, _dom_node_dispatch_event,                           \
        _dom_node_add_event_listener_ns, _dom_node_remove_event_listener_ns
...
#define DOM_NODE_VTABLE                                                                                                \
    _dom_node_try_destroy, _dom_node_get_node_name, _dom_node_get_node_value, _dom_node_set_node_value,                \
        ...
        _dom_node_compare_document_position, _dom_node_get_text_content, _dom_node_set_text_content,                   \
...
static inline dom_exception dom_node_copy(struct dom_node_internal *old, struct dom_node_internal **copy)
{
    return ((dom_node_protect_vtable *)old->vtable)->copy(old, copy);
}
#define dom_node_copy(o, c) dom_node_copy((dom_node_internal *)(o), (dom_node_internal **)(c))

/* Following are some helper functions */
dom_exception _dom_node_copy_internal(dom_node_internal *old, dom_node_internal *new);
#define dom_node_copy_internal(o, n) _dom_node_copy_internal((dom_node_internal *)(o), (dom_node_internal *)(n))

#define dom_node_get_owner(n) ((dom_node_internal *)(n))->owner

#define dom_node_set_owner(n, d) ((dom_node_internal *)(n))->owner = (struct dom_document *)(d)

#define dom_node_get_parent(n) ((dom_node_internal *)(n))->parent

#define dom_node_set_parent(n, p) ((dom_node_internal *)(n))->parent = (dom_node_internal *)(p)
...
#define dom_node_dispatch_node_change_event(doc, node, related, change, success)                                       \
    _dom_node_dispatch_node_change_event((dom_document *)(doc), (dom_node_internal *)(node),                           \
        (dom_node_internal *)(related), (dom_mutation_type)(change), (bool *)(success))
