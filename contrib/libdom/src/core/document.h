...
#define DOM_DOCUMENT_VTABLE                                                                                            \
    _dom_document_get_doctype, _dom_document_get_implementation, _dom_document_get_document_element,                   \
        _dom_document_create_element, _dom_document_create_document_fragment, _dom_document_create_text_node,          \
        _dom_document_create_comment, _dom_document_create_cdata_section, _dom_document_create_processing_instruction, \
        _dom_document_create_attribute, _dom_document_create_entity_reference, _dom_document_get_elements_by_tag_name, \
        _dom_document_import_node, _dom_document_create_element_ns, _dom_document_create_attribute_ns,                 \
        _dom_document_get_elements_by_tag_name_ns, _dom_document_get_element_by_id, _dom_document_get_input_encoding,  \
        _dom_document_get_xml_encoding, _dom_document_get_xml_standalone, _dom_document_set_xml_standalone,            \
        _dom_document_get_xml_version, _dom_document_set_xml_version, _dom_document_get_strict_error_checking,         \
...
#define DOM_NODE_VTABLE_DOCUMENT                                                                                       \
    _dom_node_try_destroy, _dom_node_get_node_name, _dom_node_get_node_value, _dom_node_set_node_value,                \
        ...
        _dom_node_compare_document_position, _dom_document_get_text_content, _dom_document_set_text_content,           \
