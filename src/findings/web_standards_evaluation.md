...
*   **WebIDL Bindings**:
    ...
    *   Unimplemented WebIDL bindings gracefully degrade to weak stubs that log warning notices using `NSLOG(wisp, WARNING, ...)` rather than crashing, and have been pruned from `src/docs/UnimplementedJavascript.md` (now only 552 remaining stubs).
