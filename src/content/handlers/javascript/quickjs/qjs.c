...
void qjs_inject_dom_polyfills(JSContext *ctx)
{
    ...
    const char *fetch_polyfill =
        ...
        "                    const children = node._childNodes || node.childNodes;\n"
        "                    if (children) {\n"
        ...
        "                const res = traverse(this._childNodes[i]);\n"
        "                if (res) return res;\n"
        "            }\n"
        "            return null;\n"
        "        }\n"
        ...
        "        this.ordered = opt.ordered !== undefined ? !!opt.ordered : true;\n"
        "        this.maxRetransmits = opt.maxRetransmits !== undefined ? opt.maxRetransmits : null;\n"
        "        this.maxPacketLifeTime = opt.maxPacketLifeTime !== undefined ? opt.maxPacketLifeTime : null;\n"
        "        this.protocol = opt.protocol || '';\n"
        "        this.id = opt.id !== undefined ? opt.id : null;\n"
        ...
        "    }\n"
        "    send(data) {\n"
        "        if (this.readyState === 'closed') throw new Error('RTCDataChannel is closed');\n"
        "        var size = 0;\n"
        "        if (typeof data === 'string') size = data.length;\n"
        "        else if (data && data.byteLength !== undefined) size = data.byteLength;\n"
        "        else if (data && data.size !== undefined) size = data.size;\n"
        ...
        "                if (self.bufferedAmount <= self.bufferedAmountLowThreshold && typeof self.onbufferedamountlow === 'function') {\n"
        "                    var evt = new globalThis.Event('bufferedamountlow');\n"
        "                    self.onbufferedamountlow(evt);\n"
        ...
        "            var evt = new globalThis.Event('close');\n"
        "            this.onclose(evt);\n"
        ...
        "        var opt = options || {};\n"
        "        opt.label = label;\n"
        "        var dc = new globalThis.RTCDataChannel(opt);\n"
        "        return dc;\n"
        "    }\n"
        "    close() {\n"
        ...
        "        try {\n"
        "            if (elt) {\n"
        "                let tn = elt.tagName || elt.nodeName;\n"
        "                if (tn) tag = String(tn).toLowerCase();\n"
        "            }\n"
        "        } catch (e) {}\n"
        "        if (kebab === 'display') {\n"
        "            if (tag === 'head' || tag === 'style' || tag === 'script' || tag === 'template' || tag === 'rp') return 'none';\n"
        "            if (tag === 'span' || tag === 'a' || tag === 'i' || tag === 'b' || tag === 'mark' || tag === 'rt' || tag === 'data' || tag === 'time' || tag === 'sub' || tag === 'sup' || tag === 'wbr') return 'inline';\n"
        "            let isHid = false;\n"
        "            try {\n"
        "                if (elt && (elt.hidden || (typeof elt.hasAttribute === 'function' && elt.hasAttribute('hidden')))) isHid = true;\n"
        "            } catch (e) {}\n"
        "            if (isHid) return 'none';\n"
        "            return 'block';\n"
        "        }\n"
        "        if (kebab === 'background-color') {\n"
        "            if (tag === 'mark') return 'rgb(255, 255, 0)';\n"
        "            return 'transparent';\n"
        "        }\n"
        "        if (kebab === 'width') return '1024px';\n"
        "        if (kebab === 'height') return '768px';\n"
        "        if (kebab === 'opacity') return '1';\n"
        "        return '';\n"
        "    }\n"
        ...
        "            get() { return globalThis.navigator ? globalThis.navigator.mediaDevices : undefined; },\n"
        "            configurable: true, enumerable: true\n"
        "        });\n"
        "    }\n"
        "}\n"
        ...
        "    window.MediaDevices = globalThis.MediaDevices;\n"
        "    window.SpeechSynthesisVoice = globalThis.SpeechSynthesisVoice;\n"
        "    window.SpeechSynthesisUtterance = globalThis.SpeechSynthesisUtterance;\n"
        "    window.SpeechSynthesisEvent = globalThis.SpeechSynthesisEvent;\n"
        "    window.SpeechSynthesisErrorEvent = globalThis.SpeechSynthesisErrorEvent;\n"
        "    window.SpeechSynthesis = globalThis.SpeechSynthesis;\n"
        "}\n"
        "if (typeof Window !== 'undefined' && Window.prototype) {\n"
        "    if (!('MediaDevices' in Window.prototype)) {\n"
        "        Object.defineProperty(Window.prototype, 'MediaDevices', {\n"
        "            get() { return globalThis.MediaDevices; },\n"
        "            configurable: true, enumerable: true\n"
        "        });\n"
        "    }\n"
        "    if (!('SpeechSynthesis' in Window.prototype)) {\n"
        "        Object.defineProperty(Window.prototype, 'SpeechSynthesis', {\n"
        "            get() { return globalThis.SpeechSynthesis; },\n"
        "            configurable: true, enumerable: true\n"
        "        });\n"
        "    }\n"
        "    if (!('SpeechSynthesisUtterance' in Window.prototype)) {\n"
        "        Object.defineProperty(Window.prototype, 'SpeechSynthesisUtterance', {\n"
        "            get() { return globalThis.SpeechSynthesisUtterance; },\n"
        "            configurable: true, enumerable: true\n"
        "        });\n"
        "    }\n"
        "}\n"
        ...
        "        if (!dummy && typeof document !== 'undefined' && document && document.createElement) {\n"
        "            dummy = document.createElement('_');\n"
        "            globalThis.__wisp_dummy_supports_el = dummy;\n"
        "        }\n"
        "        if (dummy && dummy.style) {\n"
    ...
    const char *html5_polyfills =
        ...
        "    const MouseEvt = globalThis.MouseEvent || globalThis.UIEvent || globalThis.Event;\n"
        "    globalThis.PointerEvent = class PointerEvent extends MouseEvt {\n"
        "        constructor(type, initDict = {}) {\n"
        "            super(type, initDict);\n"
        "            this.pointerId = initDict.pointerId !== undefined ? Number(initDict.pointerId) : 0;\n"
        "            this.width = initDict.width !== undefined ? Number(initDict.width) : 1;\n"
        "            this.height = initDict.height !== undefined ? Number(initDict.height) : 1;\n"
        "            this.pressure = initDict.pressure !== undefined ? Number(initDict.pressure) : 0;\n"
        "            this.tangentialPressure = initDict.tangentialPressure !== undefined ? Number(initDict.tangentialPressure) : 0;\n"
        "            this.tiltX = initDict.tiltX !== undefined ? Number(initDict.tiltX) : 0;\n"
        "            this.tiltY = initDict.tiltY !== undefined ? Number(initDict.tiltY) : 0;\n"
        "            this.twist = initDict.twist !== undefined ? Number(initDict.twist) : 0;\n"
        "            this.pointerType = initDict.pointerType !== undefined ? String(initDict.pointerType) : 'mouse';\n"
        "            this.isPrimary = initDict.isPrimary !== undefined ? Boolean(initDict.isPrimary) : false;\n"
        "        }\n"
        "    };\n"
        ...
        "            if (!this._capturedPointers) this._capturedPointers = new Set();\n"
        "            this._capturedPointers.add(pointerId);\n"
        "        };\n"
        "    }\n"
        "    if (!Element.prototype.releasePointerCapture) {\n"
        "        Element.prototype.releasePointerCapture = function(pointerId) {\n"
        "            if (this._capturedPointers) this._capturedPointers.delete(pointerId);\n"
        "        };\n"
        "    }\n"
        "    if (!Element.prototype.hasPointerCapture) {\n"
        "        Element.prototype.hasPointerCapture = function(pointerId) {\n"
        "            return !!(this._capturedPointers && this._capturedPointers.has(pointerId));\n"
        "        };\n"
        "    }\n"
        "}\n"
        ...
        "            this.identifier = initDict.identifier !== undefined ? Number(initDict.identifier) : 0;\n"
        "            this.target = initDict.target !== undefined ? initDict.target : null;\n"
        "            this.screenX = initDict.screenX !== undefined ? Number(initDict.screenX) : 0;\n"
        "            this.screenY = initDict.screenY !== undefined ? Number(initDict.screenY) : 0;\n"
        "            this.clientX = initDict.clientX !== undefined ? Number(initDict.clientX) : 0;\n"
        "            this.clientY = initDict.clientY !== undefined ? Number(initDict.clientY) : 0;\n"
        "            this.pageX = initDict.pageX !== undefined ? Number(initDict.pageX) : 0;\n"
        "            this.pageY = initDict.pageY !== undefined ? Number(initDict.pageY) : 0;\n"
        "            this.radiusX = initDict.radiusX !== undefined ? Number(initDict.radiusX) : 0;\n"
        "            this.radiusY = initDict.radiusY !== undefined ? Number(initDict.radiusY) : 0;\n"
        "            this.rotationAngle = initDict.rotationAngle !== undefined ? Number(initDict.rotationAngle) : 0;\n"
        "            this.force = initDict.force !== undefined ? Number(initDict.force) : 0;\n"
        "        }\n"
        "    };\n"
        "    if (typeof window !== 'undefined') window.Touch = globalThis.Touch;\n"
        "}\n"
        "if (typeof globalThis.TouchList === 'undefined') {\n"
        ...
        "        }\n"
        "    };\n"
        "    if (typeof window !== 'undefined') window.TouchList = globalThis.TouchList;\n"
        "}\n"
        "if (typeof globalThis.TouchEvent === 'undefined') {\n"
        "    const UIEvt = globalThis.UIEvent || globalThis.Event;\n"
        "    globalThis.TouchEvent = class TouchEvent extends UIEvt {\n"
        "        constructor(type, initDict = {}) {\n"
        "            super(type, initDict);\n"
        "            this.touches = initDict.touches ? (initDict.touches instanceof globalThis.TouchList ? initDict.touches : new globalThis.TouchList(initDict.touches)) : new globalThis.TouchList();\n"
        "            this.targetTouches = initDict.targetTouches ? (initDict.targetTouches instanceof globalThis.TouchList ? initDict.targetTouches : new globalThis.TouchList(initDict.targetTouches)) : new globalThis.TouchList();\n"
        "            this.changedTouches = initDict.changedTouches ? (initDict.changedTouches instanceof globalThis.TouchList ? initDict.changedTouches : new globalThis.TouchList(initDict.changedTouches)) : new globalThis.TouchList();\n"
        "            this.altKey = initDict.altKey !== undefined ? Boolean(initDict.altKey) : false;\n"
        "            this.metaKey = initDict.metaKey !== undefined ? Boolean(initDict.metaKey) : false;\n"
        "            this.ctrlKey = initDict.ctrlKey !== undefined ? Boolean(initDict.ctrlKey) : false;\n"
        "            this.shiftKey = initDict.shiftKey !== undefined ? Boolean(initDict.shiftKey) : false;\n"
        "        }\n"
        "    };\n"
        "    if (typeof window !== 'undefined') window.TouchEvent = globalThis.TouchEvent;\n"
        "}\n"
        "if (typeof Document !== 'undefined' && Document.prototype) {\n"
        "    if (!Document.prototype.createTouch) {\n"
        "        Document.prototype.createTouch = function(view, target, identifier, pageX, pageY, screenX, screenY, clientX, clientY, radiusX, radiusY, rotationAngle, force) {\n"
        ...
        "            let list = touches;\n"
        "            if (touches.length === 1 && Array.isArray(touches[0])) {\n"
        "                list = touches[0];\n"
        "            }\n"
        "            return new globalThis.TouchList(...list);\n"
        "        };\n"
        "    }\n"
        "}\n"
        "\n"
        ...
        "(function() {\n"
        "    const touchEvts = ['ontouchstart', 'ontouchend', 'ontouchmove', 'ontouchcancel'];\n"
        "    const ptrEvts = ['onpointerdown', 'onpointermove', 'onpointerup', 'onpointercancel', 'onpointerover', 'onpointerout', 'onpointerenter', 'onpointerleave', 'ongotpointercapture', 'onlostpointercapture'];\n"
        "    const targets = [typeof window !== 'undefined' ? window : null, typeof Document !== 'undefined' ? Document.prototype : null, typeof Element !== 'undefined' ? Element.prototype : null];\n"
        "    targets.forEach(obj => {\n"
        "        if (obj) {\n"
        "            [...touchEvts, ...ptrEvts].forEach(evt => {\n"
        "                if (!(evt in obj)) {\n"
        "                    Object.defineProperty(obj, evt, { get() { return this['_' + evt] || null; }, set(v) { this['_' + evt] = v; }, configurable: true });\n"
        "                }\n"
        "            });\n"
        "        }\n"
        "    });\n"
        ...
        "if (typeof globalThis.SourceBuffer === 'undefined') {\n"
        "    globalThis.SourceBuffer = class SourceBuffer extends globalThis.EventTarget {\n"
        "        constructor() {\n"
        "            super();\n"
        "            this.updating = false;\n"
        ...
        "            this.mode = 'segments';\n"
        "            this.buffered = { length: 0, start(i) { return 0; }, end(i) { return 0; } };\n"
        "        }\n"
        "        appendBuffer(data) {}\n"
        "        remove(start, end) {}\n"
        "        abort() {}\n"
        ...
        "    };\n"
        "}\n"
        "if (typeof globalThis.SourceBufferList === 'undefined') {\n"
        "    globalThis.SourceBufferList = class SourceBufferList extends globalThis.EventTarget {\n"
        "        constructor() {\n"
        "            super();\n"
        "            this._list = [];\n"
        "        }\n"
        ...
        "        _add(sb) { this._list.push(sb); this[this._list.length - 1] = sb; }\n"
        "        _remove(sb) {\n"
        "            var idx = this._list.indexOf(sb);\n"
        "            if (idx !== -1) {\n"
        "                this._list.splice(idx, 1);\n"
        "                delete this[this._list.length];\n"
        "            }\n"
        "        }\n"
        "    };\n"
        "}\n"
        ...
        "            this.activeSourceBuffers = new globalThis.SourceBufferList();\n"
        ...
        "            try {\n"
        "                var video = (typeof globalThis.document !== 'undefined' && globalThis.document && typeof globalThis.document.createElement === 'function') ? globalThis.document.createElement('video') : null;\n"
        ...
        "            var valid = [\n"
        "                'video/mp4', 'audio/mp4', 'audio/m4a', 'audio/x-m4a', 'video/mp2t', 'audio/mp2t',\n"
        "                'video/quicktime', 'video/x-quicktime', 'video/webm', 'audio/webm',\n"
        "                'video/x-matroska', 'video/mkv', 'audio/x-matroska',\n"
        "                'video/avi', 'video/x-msvideo', 'video/msvideo',\n"
        "                'video/ogg', 'audio/ogg', 'application/ogg',\n"
        "                'audio/mpeg', 'audio/mp3', 'audio/x-mp3', 'audio/aac', 'audio/x-aac',\n"
        "                'audio/wav', 'audio/x-wav', 'audio/wave', 'audio/opus', 'audio/flac', 'audio/x-flac',\n"
        "                'video/vp8', 'video/x-vp8', 'video/vp9', 'video/x-vp9', 'video/av1', 'video/x-av1', 'video/av2', 'video/x-av2',\n"
        "                'video/mpeg', 'video/3gpp', 'video/3gpp2', 'audio/3gpp', 'audio/3gpp2',\n"
        "                'application/vnd.apple.mpegurl', 'application/x-mpegurl', 'audio/mpegurl',\n"
        "                'audio/aiff', 'audio/x-aiff', 'audio/basic', 'video/x-flv', 'video/flv',\n"
        "                'video/x-ms-wmv', 'audio/x-ms-wma', 'image/avif', 'image/avif-sequence'\n"
        "            ];\n"
        "            return valid.indexOf(mime) !== -1;\n"
        "        }\n"
        "        addSourceBuffer(type) {\n"
        "            var sb = new globalThis.SourceBuffer();\n"
        ...
        "        }\n"
        "        endOfStream(error) { this.readyState = 'ended'; }\n"
        ...
        "(function() {\n"
        "    var BaseTarget = (typeof globalThis.EventTarget === 'function') ? globalThis.EventTarget : Object;\n"
        "    if (typeof globalThis.MediaKeyStatusMap === 'undefined') {\n"
        "        globalThis.MediaKeyStatusMap = class MediaKeyStatusMap {\n"
        "            constructor(entries) {\n"
        ...
        "            keys() { return this._map.keys(); }\n"
        "            values() { return this._map.values(); }\n"
        "            forEach(cb, thisArg) { return this._map.forEach(cb, thisArg); }\n"
        "            [Symbol.iterator]() { return this._map[Symbol.iterator](); }\n"
        "        };\n"
        "        if (typeof window !== 'undefined') window.MediaKeyStatusMap = globalThis.MediaKeyStatusMap;\n"
        "        if (typeof Window !== 'undefined' && Window.prototype) Window.prototype.MediaKeyStatusMap = globalThis.MediaKeyStatusMap;\n"
        "    }\n"
        "    if (typeof globalThis.MediaKeySession === 'undefined') {\n"
        "        globalThis.MediaKeySession = class MediaKeySession extends BaseTarget {\n"
        "            constructor(keySystem) {\n"
        "                super();\n"
        "                this.sessionId = 'wisp_eme_session_' + Math.random().toString(36).substring(2, 9);\n"
        "                this.expiration = NaN;\n"
        "                this.keyStatuses = new globalThis.MediaKeyStatusMap();\n"
        "                this.closed = new Promise(function() {});\n"
        "                this.onkeystatuseschange = null;\n"
        "                this.onmessage = null;\n"
        "                this._keySystem = keySystem || 'com.widevine.alpha';\n"
        "            }\n"
        "            generateRequest(initDataType, initData) {\n"
        "                var self = this;\n"
        "                setTimeout(function() {\n"
        "                    if (typeof self.onmessage === 'function') {\n"
        "                        var msgEvt = new globalThis.Event('message');\n"
        "                        msgEvt.messageType = 'license-request';\n"
        "                        msgEvt.message = new ArrayBuffer(16);\n"
        "                        self.onmessage(msgEvt);\n"
        "                    }\n"
        "                }, 0);\n"
        "                return Promise.resolve();\n"
        "            }\n"
        "            load(sessionId) { return Promise.resolve(true); }\n"
        "            update(response) { return Promise.resolve(); }\n"
        "            close() { return Promise.resolve(); }\n"
        "            remove() { return Promise.resolve(); }\n"
        "        };\n"
        "        if (typeof window !== 'undefined') window.MediaKeySession = globalThis.MediaKeySession;\n"
        "        if (typeof Window !== 'undefined' && Window.prototype) Window.prototype.MediaKeySession = globalThis.MediaKeySession;\n"
        "    }\n"
        "    if (typeof globalThis.MediaKeys === 'undefined') {\n"
        "        globalThis.MediaKeys = class MediaKeys {\n"
        "            constructor(keySystem) {\n"
        "                this._keySystem = keySystem || 'com.widevine.alpha';\n"
        "            }\n"
        "            createSession(sessionType) {\n"
        "                return new globalThis.MediaKeySession(this._keySystem);\n"
        "            }\n"
        ...
        "            }\n"
        "        };\n"
        "        if (typeof window !== 'undefined') window.MediaKeys = globalThis.MediaKeys;\n"
        "        if (typeof Window !== 'undefined' && Window.prototype) Window.prototype.MediaKeys = globalThis.MediaKeys;\n"
        "    }\n"
        "    if (typeof globalThis.MediaKeySystemAccess === 'undefined') {\n"
        "        globalThis.MediaKeySystemAccess = class MediaKeySystemAccess {\n"
        "            constructor(keySystem, configs) {\n"
        "                this.keySystem = keySystem || 'com.widevine.alpha';\n"
        "                this._configs = configs || [{\n"
        "                    initDataTypes: ['cenc', 'webm', 'keyids'],\n"
        "                    audioCapabilities: [{ contentType: 'audio/mp4; codecs=\"mp4a.40.2\"', robustness: 'SW_SECURE_CRYPTO' }],\n"
        "                    videoCapabilities: [{ contentType: 'video/mp4; codecs=\"avc1.4d401f\"', robustness: 'SW_SECURE_CRYPTO' }],\n"
        ...
        "            }\n"
        "            createMediaKeys() {\n"
        "                return Promise.resolve(new globalThis.MediaKeys(this.keySystem));\n"
        "            }\n"
        "        };\n"
        "        if (typeof window !== 'undefined') window.MediaKeySystemAccess = globalThis.MediaKeySystemAccess;\n"
        "        if (typeof Window !== 'undefined' && Window.prototype) Window.prototype.MediaKeySystemAccess = globalThis.MediaKeySystemAccess;\n"
        "    }\n"
        "    if (typeof globalThis.MediaEncryptedEvent === 'undefined') {\n"
        "        var BaseEvent = (typeof globalThis.Event === 'function') ? globalThis.Event : Object;\n"
        "        globalThis.MediaEncryptedEvent = class MediaEncryptedEvent extends BaseEvent {\n"
        "            constructor(type, eventInitDict) {\n"
        "                super(type, eventInitDict);\n"
        "                eventInitDict = eventInitDict || {};\n"
        "                this.initDataType = eventInitDict.initDataType || '';\n"
        "                this.initData = eventInitDict.initData || null;\n"
        "            }\n"
        "        };\n"
        "        if (typeof window !== 'undefined') window.MediaEncryptedEvent = globalThis.MediaEncryptedEvent;\n"
        "        if (typeof Window !== 'undefined' && Window.prototype) Window.prototype.MediaEncryptedEvent = globalThis.MediaEncryptedEvent;\n"
        "    }\n"
        "    if (globalThis.navigator && typeof globalThis.navigator.requestMediaKeySystemAccess !== 'function') {\n"
        "        globalThis.navigator.requestMediaKeySystemAccess = function requestMediaKeySystemAccess(keySystem, supportedConfigurations) {\n"
        "            var knownKeySystems = [\n"
        "                'com.widevine.alpha',\n"
        "                'org.w3.clearkey',\n"
        ...
        "                'com.apple.fps.1_0'\n"
        "            ];\n"
        "            if (!keySystem || (typeof keySystem === 'string' && knownKeySystems.indexOf(keySystem) === -1 && keySystem.indexOf('widevine') === -1 && keySystem.indexOf('clearkey') === -1)) {\n"
        "                var DomExc = (typeof globalThis.DOMException === 'function') ? globalThis.DOMException : Error;\n"
        "                return Promise.reject(new DomExc('Unsupported keySystem: ' + keySystem, 'NotSupportedError'));\n"
        "            }\n"
        "            return Promise.resolve(new globalThis.MediaKeySystemAccess(keySystem, supportedConfigurations));\n"
        "        };\n"
        "    }\n"
        "    if (globalThis.HTMLMediaElement && globalThis.HTMLMediaElement.prototype) {\n"
        "        if (!('setMediaKeys' in globalThis.HTMLMediaElement.prototype)) {\n"
        "            globalThis.HTMLMediaElement.prototype.setMediaKeys = function setMediaKeys(mediaKeys) {\n"
        "                this._mediaKeys = mediaKeys || null;\n"
        "                return Promise.resolve();\n"
        "            };\n"
        "        }\n"
        "        if (!('mediaKeys' in globalThis.HTMLMediaElement.prototype)) {\n"
        "            Object.defineProperty(globalThis.HTMLMediaElement.prototype, 'mediaKeys', {\n"
        "                get: function() { return this._mediaKeys || null; },\n"
        "                configurable: true, enumerable: true\n"
        "            });\n"
        "        }\n"
        "        if (!('onencrypted' in globalThis.HTMLMediaElement.prototype)) {\n"
        "            globalThis.HTMLMediaElement.prototype.onencrypted = null;\n"
        "        }\n"
        "    }\n"
        "})();\n"
        "\n"
        "/* Web Animations API & Animation Frame Vendor Prefixes */\n"
        "if (typeof globalThis.Animation === 'undefined') {\n"
        "    var BaseTarget = (typeof globalThis.EventTarget === 'function') ? globalThis.EventTarget : Object;\n"
        "    var Animation = class Animation extends BaseTarget {\n"
        ...
        "    var KeyframeEffect = class KeyframeEffect {\n"
        ...
        "        }\n"
        "        getKeyframes() { return []; }\n"
        "        setKeyframes(keyframes) { this.keyframes = keyframes; }\n"
        "    };\n"
        "    globalThis.KeyframeEffect = KeyframeEffect;\n"
        "    if (typeof window !== 'undefined') window.KeyframeEffect = KeyframeEffect;\n"
        "}\n"
        "if (typeof globalThis.AnimationEffect === 'undefined') {\n"
        "    var AnimationEffect = class AnimationEffect {};\n"
        "    globalThis.AnimationEffect = AnimationEffect;\n"
        "    if (typeof window !== 'undefined') window.AnimationEffect = AnimationEffect;\n"
        "}\n"
        "if (typeof globalThis.DocumentTimeline === 'undefined') {\n"
        "    var DocumentTimeline = class DocumentTimeline {\n"
        "        constructor(options) {\n"
        "            this.currentTime = (typeof performance !== 'undefined' && performance.now) ? performance.now() : Date.now();\n"
        "        }\n"
        "    };\n"
        "    globalThis.DocumentTimeline = DocumentTimeline;\n"
        "    if (typeof window !== 'undefined') window.DocumentTimeline = DocumentTimeline;\n"
        "}\n"
        "if (typeof Document !== 'undefined' && Document.prototype) {\n"
        "    if (!('timeline' in Document.prototype)) {\n"
        "        Object.defineProperty(Document.prototype, 'timeline', {\n"
        "            get: function() {\n"
        "                if (!this._timeline) {\n"
        "                    this._timeline = new globalThis.DocumentTimeline();\n"
        "                }\n"
        ...
        "    try { document.timeline = new globalThis.DocumentTimeline(); } catch(e) {}\n"
        "}\n"
        "if (typeof Element !== 'undefined' && Element.prototype) {\n"
        "    if (!Element.prototype.animate) {\n"
        "        Element.prototype.animate = function(keyframes, options) {\n"
        "            var tl = (this.ownerDocument && this.ownerDocument.timeline) ? this.ownerDocument.timeline : (typeof document !== 'undefined' ? document.timeline : null);\n"
        "            var anim = new globalThis.Animation(new globalThis.KeyframeEffect(this, keyframes, options), tl);\n"
        "            anim.play();\n"
        "            return anim;\n"
        "        };\n"
        "    }\n"
        ...
        "        window.mozRequestAnimationFrame = window.mozRequestAnimationFrame || window.requestAnimationFrame;\n"
        "        window.msRequestAnimationFrame = window.msRequestAnimationFrame || window.requestAnimationFrame;\n"
        "        window.oRequestAnimationFrame = window.oRequestAnimationFrame || window.requestAnimationFrame;\n"
        "    }\n"
        "    if (window.cancelAnimationFrame) {\n"
        "        window.webkitCancelAnimationFrame = window.webkitCancelAnimationFrame || window.cancelAnimationFrame;\n"
        "        window.mozCancelAnimationFrame = window.mozCancelAnimationFrame || window.cancelAnimationFrame;\n"
        "        window.msCancelAnimationFrame = window.msCancelAnimationFrame || window.cancelAnimationFrame;\n"
        "        window.oCancelAnimationFrame = window.oCancelAnimationFrame || window.cancelAnimationFrame;\n"
        "    }\n"
        "}\n"
        "\n"
        "/* Beacon API */\n"
        ...
        "    globalThis.FontFace = function FontFace(family, source, descriptors) {\n"
        ...
        "    };\n"
        "    globalThis.FontFace.prototype.load = function() { return this.loaded; };\n"
        "}\n"
        "if (typeof globalThis.FontFaceSet === 'undefined') {\n"
        "    globalThis.FontFaceSet = function FontFaceSet() {\n"
        "        this._fonts = new Set();\n"
        "        this.status = 'loaded';\n"
        "    };\n"
        "    if (globalThis.EventTarget && globalThis.EventTarget.prototype) {\n"
        "        globalThis.FontFaceSet.prototype = Object.create(globalThis.EventTarget.prototype);\n"
        "        globalThis.FontFaceSet.prototype.constructor = globalThis.FontFaceSet;\n"
        "    }\n"
        "    Object.defineProperty(globalThis.FontFaceSet.prototype, 'ready', {\n"
        "        get() {\n"
        ...
        "        configurable: true\n"
        "    });\n"
        "    globalThis.FontFaceSet.prototype.add = function(font) { this._fonts.add(font); return this; };\n"
        "    globalThis.FontFaceSet.prototype.delete = function(font) { return this._fonts.delete(font); };\n"
        "    globalThis.FontFaceSet.prototype.clear = function() { this._fonts.clear(); };\n"
        "    globalThis.FontFaceSet.prototype.has = function(font) { return this._fonts.has(font); };\n"
        "    globalThis.FontFaceSet.prototype.check = function(font, text) { return true; };\n"
        "    globalThis.FontFaceSet.prototype.load = function(font, text) { return Promise.resolve(Array.from(this._fonts)); };\n"
        "    Object.defineProperty(globalThis.FontFaceSet.prototype, 'size', {\n"
        "        get() { return this._fonts.size; },\n"
        "        configurable: true\n"
        "    });\n"
        "    globalThis.FontFaceSet.prototype.values = function() { return this._fonts.values(); };\n"
        "    globalThis.FontFaceSet.prototype.keys = function() { return this._fonts.keys(); };\n"
        "    globalThis.FontFaceSet.prototype.entries = function() { return this._fonts.entries(); };\n"
        "    globalThis.FontFaceSet.prototype[Symbol.iterator] = function() { return this._fonts[Symbol.iterator](); };\n"
        "    globalThis.FontFaceSet.prototype.forEach = function(cb, thisArg) { this._fonts.forEach(cb, thisArg); };\n"
        "}\n"
        "var _global_fonts = new globalThis.FontFaceSet();\n"
        "if (typeof Document !== 'undefined' && Document.prototype) {\n"
        "    if (!('fonts' in Document.prototype)) {\n"
        "        Object.defineProperty(Document.prototype, 'fonts', {\n"
        "            get() { return _global_fonts; },\n"
        "            configurable: true,\n"
        "            enumerable: true\n"
        "        });\n"
        "    }\n"
        ...
        "    if (!('fonts' in HTMLDocument.prototype)) {\n"
        "        Object.defineProperty(HTMLDocument.prototype, 'fonts', {\n"
        "            get() { return _global_fonts; },\n"
        "            configurable: true,\n"
        "            enumerable: true\n"
        "        });\n"
        ...
        "    try { document.fonts = _global_fonts; } catch(e) {}\n"
        "}\n"
        "\n"
        ...
        "    })();\n"
        "}\n"
        "if (typeof globalThis.PushSubscriptionOptions === 'undefined') {\n"
        "    globalThis.PushSubscriptionOptions = class PushSubscriptionOptions {\n"
        "        constructor(options) {\n"
        "            options = options || {};\n"
        "            this.userVisibleOnly = !!options.userVisibleOnly;\n"
        "            this.applicationServerKey = options.applicationServerKey || null;\n"
        "        }\n"
        "    };\n"
        "}\n"
        "if (typeof globalThis.PushSubscription === 'undefined') {\n"
        "    globalThis.PushSubscription = class PushSubscription {\n"
        "        constructor(options) {\n"
        "            this.endpoint = 'https://push.services.mozilla.com/push/v1/stub_endpoint';\n"
        "            this.expirationTime = null;\n"
        "            this.options = new globalThis.PushSubscriptionOptions(options);\n"
        "        }\n"
        "        getKey(name) {\n"
        ...
        "        }\n"
        "        subscribe(options) {\n"
        "            return Promise.resolve(new globalThis.PushSubscription(options));\n"
        "        }\n"
        "        getSubscription() {\n"
        ...
        "}\n"
        "if (typeof window !== 'undefined') {\n"
        "    if (!('PushManager' in window)) window.PushManager = globalThis.PushManager;\n"
        "    if (!('PushSubscription' in window)) window.PushSubscription = globalThis.PushSubscription;\n"
        "    if (!('PushSubscriptionOptions' in window)) window.PushSubscriptionOptions = globalThis.PushSubscriptionOptions;\n"
        "}\n"
        "\n"
        "/* Web SQL Database */\n"
        ...
        "/* Page Visibility API */\n"
        "if (typeof Document !== 'undefined' && Document.prototype) {\n"
        "    if (!('visibilityState' in Document.prototype)) Object.defineProperty(Document.prototype, 'visibilityState', { get() { return 'visible'; }, configurable: true });\n"
        "    if (!('hidden' in Document.prototype)) Object.defineProperty(Document.prototype, 'hidden', { get() { return false; }, configurable: true });\n"
        "}\n"
        "if (typeof HTMLDocument !== 'undefined' && HTMLDocument.prototype) {\n"
        "    if (!('visibilityState' in HTMLDocument.prototype)) Object.defineProperty(HTMLDocument.prototype, 'visibilityState', { get() { return 'visible'; }, configurable: true });\n"
        "    if (!('hidden' in HTMLDocument.prototype)) Object.defineProperty(HTMLDocument.prototype, 'hidden', { get() { return false; }, configurable: true });\n"
        "}\n"
        ...
        "    };\n"
        "}\n"
        "if (typeof Document !== 'undefined' && Document.prototype && !Document.prototype.getSelection) {\n"
        "    Document.prototype.getSelection = function() { return window.getSelection ? window.getSelection() : null; };\n"
        "}\n"
        "if (typeof document !== 'undefined' && document && !document.getSelection) {\n"
        "    document.getSelection = function() { return window.getSelection ? window.getSelection() : null; };\n"
        "}\n"
        "\n"
        "/* scrollIntoView */\n"
        ...
        "}\n"
        "\n"
        "/* ImageBitmapRenderingContext & OffscreenCanvas & WebGL / WebGL2 Context Classes */\n"
        "if (typeof globalThis.ImageBitmapRenderingContext === 'undefined') {\n"
        "    globalThis.ImageBitmapRenderingContext = class ImageBitmapRenderingContext {\n"
        "        constructor(canvas) {\n"
        "            Object.defineProperty(this, 'canvas', { value: canvas || null, writable: true, configurable: true });\n"
        "        }\n"
        ...
        "        constructor(w = 300, h = 150) { super(); this.width = w; this.height = h; }\n"
        "        getContext(contextId) {\n"
        "            if (contextId === '2d') {\n"
        "                if (!this._2d_context) {\n"
        "                    if (typeof CanvasRenderingContext2D !== 'undefined') {\n"
        "                        this._2d_context = Object.create(CanvasRenderingContext2D.prototype);\n"
        "                    } else {\n"
        "                        this._2d_context = {};\n"
        "                    }\n"
        "                    Object.defineProperty(this._2d_context, 'canvas', { value: this, writable: true, configurable: true });\n"
        "                }\n"
        "                return this._2d_context;\n"
        "            }\n"
        "            if (contextId === 'webgl' || contextId === 'experimental-webgl') {\n"
        "                if (!this._webgl_context && typeof WebGLRenderingContext !== 'undefined') {\n"
        "                    this._webgl_context = new WebGLRenderingContext(this);\n"
        "                }\n"
        "                return this._webgl_context || null;\n"
        "            }\n"
        "            if (contextId === 'webgl2' || contextId === 'experimental-webgl2') {\n"
        "                if (!this._webgl2_context && typeof WebGL2RenderingContext !== 'undefined') {\n"
        "                    this._webgl2_context = new WebGL2RenderingContext(this);\n"
        "                }\n"
        "                return this._webgl2_context || null;\n"
        "            }\n"
        "            if (contextId === 'bitmaprenderer') {\n"
        "                if (!this._bitmaprenderer_context && typeof ImageBitmapRenderingContext !== 'undefined') {\n"
        "                    this._bitmaprenderer_context = new ImageBitmapRenderingContext(this);\n"
        "                }\n"
        "                return this._bitmaprenderer_context || null;\n"
        "            }\n"
        "            return null;\n"
        "        }\n"
...
"    var SecurityPolicyViolationEvent = function SecurityPolicyViolationEvent(type, init) {\n"
"        init = init || {};\n"
"        var evt = (typeof globalThis.Event === 'function') ? new globalThis.Event(type, init) : { type: type };\n"
"        evt.documentURI = init.documentURI || '';\n"
"        evt.referrer = init.referrer || '';\n"
"        evt.blockedURI = init.blockedURI || '';\n"
"        evt.violatedDirective = init.violatedDirective || '';\n"
"        evt.effectiveDirective = init.effectiveDirective || '';\n"
"        evt.originalPolicy = init.originalPolicy || '';\n"
"        evt.disposition = init.disposition || 'enforce';\n"
"        evt.statusCode = init.statusCode || 200;\n"
"        evt.sourceFile = init.sourceFile || '';\n"
"        evt.lineNumber = init.lineNumber || 0;\n"
"        evt.columnNumber = init.columnNumber || 0;\n"
"        evt.sample = init.sample || '';\n"
"        if (SecurityPolicyViolationEvent.prototype) {\n"
"            Object.setPrototypeOf(evt, SecurityPolicyViolationEvent.prototype);\n"
        "        }\n"
"        return evt;\n"
        "    };\n"
"    if (globalThis.Event && globalThis.Event.prototype) {\n"
"        SecurityPolicyViolationEvent.prototype = Object.create(globalThis.Event.prototype);\n"
...
"        window.SecurityPolicyViolationEvent = SecurityPolicyViolationEvent;\n"
    ...
    const char *webgl_polyfill =
        "(() => {\n"
        "    'use strict';\n"
        "    const global = globalThis;\n"
        "\n"
        "    if (typeof global.WebGLBuffer === 'undefined') {\n"
        "        var WebGLBuffer = class WebGLBuffer {\n"
        "            constructor() { this.__wisp_type = 'WebGLBuffer'; }\n"
        "        };\n"
        "        global.WebGLBuffer = WebGLBuffer;\n"
        "    }\n"
        "\n"
        "    if (typeof global.WebGLShader === 'undefined') {\n"
        "        var WebGLShader = class WebGLShader {\n"
        "            constructor(type) {\n"
        "                this.__wisp_type = 'WebGLShader';\n"
        "                this.type = type;\n"
        "                this.source = '';\n"
        "                this.compiled = true;\n"
        "            }\n"
        ...
        "    }\n"
        "\n"
        "    if (typeof global.WebGLProgram === 'undefined') {\n"
        "        var WebGLProgram = class WebGLProgram {\n"
        "            constructor() {\n"
        "                this.__wisp_type = 'WebGLProgram';\n"
        "                this.shaders = [];\n"
        "                this.linked = true;\n"
        "            }\n"
        "        };\n"
        ...
        "    }\n"
        "\n"
        "    if (typeof global.WebGLTexture === 'undefined') {\n"
        "        var WebGLTexture = class WebGLTexture {\n"
        "            constructor() { this.__wisp_type = 'WebGLTexture'; }\n"
        "        };\n"
        "        global.WebGLTexture = WebGLTexture;\n"
        "    }\n"
        "\n"
        "    if (typeof global.WebGLFramebuffer === 'undefined') {\n"
        "        var WebGLFramebuffer = class WebGLFramebuffer {\n"
        "            constructor() { this.__wisp_type = 'WebGLFramebuffer'; }\n"
        "        };\n"
        "        global.WebGLFramebuffer = WebGLFramebuffer;\n"
        "    }\n"
        "\n"
        "    if (typeof global.WebGLRenderbuffer === 'undefined') {\n"
        "        var WebGLRenderbuffer = class WebGLRenderbuffer {\n"
        "            constructor() { this.__wisp_type = 'WebGLRenderbuffer'; }\n"
        "        };\n"
        "        global.WebGLRenderbuffer = WebGLRenderbuffer;\n"
        "    }\n"
        "\n"
        "    if (typeof global.WebGLUniformLocation === 'undefined') {\n"
        "        var WebGLUniformLocation = class WebGLUniformLocation {\n"
        "            constructor(name) { this.name = name; }\n"
        "        };\n"
        "        global.WebGLUniformLocation = WebGLUniformLocation;\n"
        "    }\n"
        "\n"
        "    if (typeof global.WebGLActiveInfo === 'undefined') {\n"
        "        var WebGLActiveInfo = class WebGLActiveInfo {\n"
        "            constructor(name = '', size = 1, type = 0x1406) {\n"
        "                this.name = name;\n"
        "                this.size = size;\n"
        "                this.type = type;\n"
        "            }\n"
        ...
        "    }\n"
        "\n"
        "    if (typeof global.WebGLShaderPrecisionFormat === 'undefined') {\n"
        "        var WebGLShaderPrecisionFormat = class WebGLShaderPrecisionFormat {\n"
        "            constructor(rangeMin = 127, rangeMax = 127, precision = 23) {\n"
        ...
        "    }\n"
        "\n"
        "    if (typeof global.WebGLQuery === 'undefined') {\n"
        "        var WebGLQuery = class WebGLQuery {};\n"
        "        global.WebGLQuery = WebGLQuery;\n"
        "    }\n"
        "    if (typeof global.WebGLSampler === 'undefined') {\n"
        "        var WebGLSampler = class WebGLSampler {};\n"
        "        global.WebGLSampler = WebGLSampler;\n"
        "    }\n"
        "    if (typeof global.WebGLSync === 'undefined') {\n"
        "        var WebGLSync = class WebGLSync {};\n"
        "        global.WebGLSync = WebGLSync;\n"
        "    }\n"
        "    if (typeof global.WebGLTransformFeedback === 'undefined') {\n"
        "        var WebGLTransformFeedback = class WebGLTransformFeedback {};\n"
        "        global.WebGLTransformFeedback = WebGLTransformFeedback;\n"
        "    }\n"
        "    if (typeof global.WebGLVertexArrayObject === 'undefined') {\n"
        "        var WebGLVertexArrayObject = class WebGLVertexArrayObject {};\n"
        ...
        "        MAX_VARYING_VECTORS: 0x8DF8,\n"
        "        MAX_COMBINED_TEXTURE_IMAGE_UNITS: 0x8B4D,\n"
        "        MAX_VERTEX_TEXTURE_IMAGE_UNITS: 0x8B4C,\n"
        "        MAX_TEXTURE_IMAGE_UNITS: 0x8872,\n"
        "        MAX_FRAGMENT_UNIFORM_VECTORS: 0x8DFD,\n"
        "        MAX_RENDERBUFFER_SIZE: 0x84E8,\n"
        "        MAX_TEXTURE_SIZE: 0x851C,\n"
        "        MAX_CUBE_MAP_TEXTURE_SIZE: 0x851D,\n"
        ...
        "            checkFramebufferStatus(target) { return 0x8CD5; }\n"
        "            clear(mask) {}\n"
        ...
        "            copyTexImage2D() {}\n"
        "            copyTexSubImage2D() {}\n"
        "            createBuffer() { return new global.WebGLBuffer(); }\n"
        "            createFramebuffer() { return new global.WebGLFramebuffer(); }\n"
        "            createProgram() { return new global.WebGLProgram(); }\n"
        "            createRenderbuffer() { return new global.WebGLRenderbuffer(); }\n"
        "            createShader(type) { return new global.WebGLShader(type); }\n"
        "            createTexture() { return new global.WebGLTexture(); }\n"
        "            cullFace(mode) {}\n"
        "            deleteBuffer(buffer) {}\n"
        ...
        "            getActiveAttrib(program, index) { return new global.WebGLActiveInfo('attrib', 1, 0x1406); }\n"
        "            getActiveUniform(program, index) { return new global.WebGLActiveInfo('uniform', 1, 0x1406); }\n"
        "            getAttachedShaders(program) { return program ? (program.shaders || []) : []; }\n"
        "            getAttribLocation(program, name) { return 0; }\n"
        "            getParameter(pname) {\n"
        "                switch (pname) {\n"
        "                    case 0x1F00: return 'Wisp WebGL Engine';\n"
        "                    case 0x1F01: return 'Wisp WebGL Driver';\n"
        "                    case 0x1F02: return 'WebGL 1.0 (Wisp Embedded)';\n"
        "                    case 0x8B8C: return 'WebGL GLSL ES 1.0';\n"
        "                    case 0x851C: return 16384;\n"
        "                    case 0x851D: return 16384;\n"
        "                    case 0x84E8: return 16384;\n"
        "                    case 0x8869: return 16;\n"
        "                    case 0x8DFB: return 1024;\n"
        "                    case 0x8DF8: return 30;\n"
        "                    case 0x8B4D: return 32;\n"
        "                    case 0x8B4C: return 16;\n"
        "                    case 0x8872: return 16;\n"
        "                    case 0x8DFD: return 1024;\n"
        "                    case 0x0D33: return new Int32Array([16384, 16384]);\n"
        "                    case 0x846E: return new Float32Array([1, 10]);\n"
        ...
        "                if (pname === 0x8B81 || pname === 0x8B82 || pname === 0x8B83) return true;\n"
        "                return 0;\n"
        "            }\n"
        "            getProgramInfoLog(program) { return ''; }\n"
        "            getShaderParameter(shader, pname) {\n"
        "                if (pname === 0x8B81 || pname === 0x8B80) return true;\n"
        "                if (pname === 0x8B4F) return shader ? shader.type : 0x8B31;\n"
        "                return 0;\n"
        "            }\n"
        "            getShaderPrecisionFormat(shadertype, precisiontype) {\n"
        "                return new global.WebGLShaderPrecisionFormat(127, 127, 23);\n"
        "            }\n"
        "            getShaderInfoLog(shader) { return ''; }\n"
        "            getShaderSource(shader) { return shader ? shader.source : ''; }\n"
        "            getUniform(program, location) { return null; }\n"
        "            getUniformLocation(program, name) { return new global.WebGLUniformLocation(name); }\n"
        "            getVertexAttrib(index, pname) { return 0; }\n"
        "            getVertexAttribOffset(index, pname) { return 0; }\n"
        "            hint(target, mode) {}\n"
        "            isBuffer(buffer) { return buffer instanceof global.WebGLBuffer; }\n"
        "            isEnabled(cap) { return false; }\n"
        "            isFramebuffer(framebuffer) { return framebuffer instanceof global.WebGLFramebuffer; }\n"
        "            isProgram(program) { return program instanceof global.WebGLProgram; }\n"
        "            isRenderbuffer(renderbuffer) { return renderbuffer instanceof global.WebGLRenderbuffer; }\n"
        "            isShader(shader) { return shader instanceof global.WebGLShader; }\n"
        "            isTexture(texture) { return texture instanceof global.WebGLTexture; }\n"
        "            lineWidth(width) {}\n"
        ...
        "            Object.defineProperty(WebGLRenderingContext, k, { value: constants[k], enumerable: true, writable: false });\n"
        "            Object.defineProperty(WebGLRenderingContext.prototype, k, { value: constants[k], enumerable: true, writable: false });\n"
        "        }\n"
        "        global.WebGLRenderingContext = WebGLRenderingContext;\n"
        "    }\n"
        "\n"
        "    if (typeof global.WebGL2RenderingContext === 'undefined') {\n"
        "        var WebGL2RenderingContext = class WebGL2RenderingContext extends global.WebGLRenderingContext {\n"
        "            constructor(canvas = null) { super(canvas); }\n"
        "            createQuery() { return new global.WebGLQuery(); }\n"
        "            deleteQuery(query) {}\n"
        "            isQuery(query) { return query instanceof global.WebGLQuery; }\n"
        "            beginQuery(target, query) {}\n"
        "            endQuery(target) {}\n"
        "            getQuery(target, pname) { return null; }\n"
        "            getQueryParameter(query, pname) { return 0; }\n"
        "            createSampler() { return new global.WebGLSampler(); }\n"
        "            deleteSampler(sampler) {}\n"
        "            isSampler(sampler) { return sampler instanceof global.WebGLSampler; }\n"
        "            bindSampler(unit, sampler) {}\n"
        "            samplerParameteri(sampler, pname, param) {}\n"
        "            samplerParameterf(sampler, pname, param) {}\n"
        "            getSamplerParameter(sampler, pname) { return 0; }\n"
        "            fenceSync(condition, flags) { return new global.WebGLSync(); }\n"
        "            isSync(sync) { return sync instanceof global.WebGLSync; }\n"
        "            deleteSync(sync) {}\n"
        "            clientWaitSync(sync, flags, timeout) { return 0x9117; }\n"
        "            waitSync(sync, flags, timeout) {}\n"
        "            getSyncParameter(sync, pname) { return 0; }\n"
        "            createTransformFeedback() { return new global.WebGLTransformFeedback(); }\n"
        "            deleteTransformFeedback(tf) {}\n"
        "            isTransformFeedback(tf) { return tf instanceof global.WebGLTransformFeedback; }\n"
        ...
        "            createVertexArray() { return new global.WebGLVertexArrayObject(); }\n"
        "            deleteVertexArray(va) {}\n"
        "            isVertexArray(va) { return va instanceof global.WebGLVertexArrayObject; }\n"
        "            bindVertexArray(va) {}\n"
        "        };\n"
        "\n"
        "        for (let k in constants) {\n"
        "            Object.defineProperty(WebGL2RenderingContext, k, { value: constants[k], enumerable: true, writable: false });\n"
        "            Object.defineProperty(WebGL2RenderingContext.prototype, k, { value: constants[k], enumerable: true, writable: false });\n"
        "        }\n"
        ...
        "                            this._2d_context = Object.create(global.CanvasRenderingContext2D.prototype);\n"
        "                        } else {\n"
        "                            this._2d_context = {};\n"
        "                        }\n"
        "                        Object.defineProperty(this._2d_context, 'canvas', { value: this, writable: true, configurable: true });\n"
        ...
        "                }\n"
        "                if (contextId === 'webgl' || contextId === 'experimental-webgl') {\n"
        "                    if (!this._webgl_context && global.WebGLRenderingContext) this._webgl_context = new global.WebGLRenderingContext(this);\n"
        "                    return this._webgl_context || null;\n"
        "                }\n"
        "                if (contextId === 'webgl2' || contextId === 'experimental-webgl2') {\n"
        "                    if (!this._webgl2_context && global.WebGL2RenderingContext) this._webgl2_context = new global.WebGL2RenderingContext(this);\n"
        "                    return this._webgl2_context || null;\n"
        "                }\n"
        "                return null;\n"
        "            }\n"
        ...
        "\n"
        "    if (typeof Window !== 'undefined' && Window.prototype) {\n"
        "        if (!('WebGLRenderingContext' in Window.prototype)) {\n"
        "            Object.defineProperty(Window.prototype, 'WebGLRenderingContext', {\n"
        "                get() { return global.WebGLRenderingContext; },\n"
        "                configurable: true, enumerable: true\n"
        "            });\n"
        "        }\n"
        "        if (!('WebGL2RenderingContext' in Window.prototype)) {\n"
        "            Object.defineProperty(Window.prototype, 'WebGL2RenderingContext', {\n"
        "                get() { return global.WebGL2RenderingContext; },\n"
        "                configurable: true, enumerable: true\n"
        "            });\n"
        "        }\n"
        "        if (global.OffscreenCanvas && !('OffscreenCanvas' in Window.prototype)) {\n"
        "            Object.defineProperty(Window.prototype, 'OffscreenCanvas', {\n"
        "                get() { return global.OffscreenCanvas; },\n"
        "                configurable: true, enumerable: true\n"
        "            });\n"
        "        }\n"
        "        if (global.ImageBitmapRenderingContext && !('ImageBitmapRenderingContext' in Window.prototype)) {\n"
        "            Object.defineProperty(Window.prototype, 'ImageBitmapRenderingContext', {\n"
        "                get() { return global.ImageBitmapRenderingContext; },\n"
        "                configurable: true, enumerable: true\n"
        "            });\n"
        "        }\n"
        "    }\n"
        "})();\n"
        "if (typeof globalThis !== 'undefined' && globalThis.ImageBitmapRenderingContext) var ImageBitmapRenderingContext = globalThis.ImageBitmapRenderingContext;\n"
        "if (typeof globalThis !== 'undefined' && globalThis.WebGLRenderingContext) var WebGLRenderingContext = globalThis.WebGLRenderingContext;\n"
        "if (typeof globalThis !== 'undefined' && globalThis.WebGL2RenderingContext) var WebGL2RenderingContext = globalThis.WebGL2RenderingContext;\n";
    ...
    const char *svg_polyfill =
        ...
        "    }\n"
        "    if (typeof global.MathMLElement === 'undefined') {\n"
        "        var MathMLElement = class MathMLElement extends (global.Element || class {}) {\n"
        "            constructor() {\n"
        "                super();\n"
        ...
        "        var SVGFEColorMatrixElement = function SVGFEColorMatrixElement() {\n"
        "            if (SVGFEColorMatrixElement.prototype) Object.setPrototypeOf(this, SVGFEColorMatrixElement.prototype);\n"
        "        };\n"
        "        if (global.SVGElement && global.SVGElement.prototype) {\n"
        "            SVGFEColorMatrixElement.prototype = Object.create(global.SVGElement.prototype);\n"
        "            SVGFEColorMatrixElement.prototype.constructor = SVGFEColorMatrixElement;\n"
        "        }\n"
        ...
        "    }\n"
        "    if (typeof global.SVGFilterElement === 'undefined') {\n"
        "        var SVGFilterElement = function SVGFilterElement() {\n"
        "            if (SVGFilterElement.prototype) Object.setPrototypeOf(this, SVGFilterElement.prototype);\n"
        "        };\n"
        "        if (global.SVGElement && global.SVGElement.prototype) {\n"
        "            SVGFilterElement.prototype = Object.create(global.SVGElement.prototype);\n"
        "            SVGFilterElement.prototype.constructor = SVGFilterElement;\n"
        "        }\n"
        "        global.SVGFilterElement = SVGFilterElement;\n"
        "    }\n"
        "    if (typeof global.SVGAnimationElement === 'undefined') {\n"
        "        var SVGAnimationElement = class SVGAnimationElement extends global.SVGElement {\n"
        "            constructor() {\n"
        "                super();\n"
        ...
        "            getSimpleDuration() { return 0; }\n"
        "            beginElement() {}\n"
        "            beginElementAt(offset) {}\n"
        "            endElement() {}\n"
        "            endElementAt(offset) {}\n"
        "        };\n"
        "        global.SVGAnimationElement = SVGAnimationElement;\n"
        "    }\n"
        "    if (typeof global.SVGAnimateElement === 'undefined') {\n"
        "        var SVGAnimateElement = class SVGAnimateElement extends global.SVGAnimationElement {};\n"
        "        global.SVGAnimateElement = SVGAnimateElement;\n"
        "    }\n"
        "    if (typeof global.SVGAnimateTransformElement === 'undefined') {\n"
        "        var SVGAnimateTransformElement = class SVGAnimateTransformElement extends global.SVGAnimationElement {};\n"
        "        global.SVGAnimateTransformElement = SVGAnimateTransformElement;\n"
        "    }\n"
        "    if (typeof global.SVGSetElement === 'undefined') {\n"
        "        var SVGSetElement = class SVGSetElement extends global.SVGAnimationElement {};\n"
        "        global.SVGSetElement = SVGSetElement;\n"
        "    }\n"
        "    if (typeof global.SVGAnimateMotionElement === 'undefined') {\n"
        "        var SVGAnimateMotionElement = class SVGAnimateMotionElement extends global.SVGAnimationElement {};\n"
        "        global.SVGAnimateMotionElement = SVGAnimateMotionElement;\n"
        "    }\n"
        "    if (typeof Window !== 'undefined' && Window.prototype) {\n"
        "        ['MathMLElement', 'SVGElement', 'SVGGraphicsElement', 'SVGSVGElement', 'SVGForeignObjectElement', 'SVGFEColorMatrixElement', 'SVGFilterElement', 'SVGAnimationElement', 'SVGAnimateElement', 'SVGAnimateTransformElement', 'SVGSetElement', 'SVGAnimateMotionElement'].forEach(name => {\n"
...
void drain_mutation_queue(shm_dom_t *shm, struct dom_document *doc) {
    ...
    while (tail != head) {
        uint32_t idx = tail % SHM_MUTATION_QUEUE_SIZE;
