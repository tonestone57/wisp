...
"        window.SecurityPolicyViolationEvent = SecurityPolicyViolationEvent;\n"
    ...
    const char *svg_polyfill =
        ...
        "    }\n"
        "    if (typeof Window !== 'undefined' && Window.prototype) {\n"
        "        ['MathMLElement', 'SVGElement', 'SVGGraphicsElement', 'SVGSVGElement', 'SVGForeignObjectElement', 'SVGFEColorMatrixElement', 'SVGFilterElement', 'SVGAnimationElement', 'SVGAnimateElement', 'SVGAnimateTransformElement'].forEach(name => {\n"
