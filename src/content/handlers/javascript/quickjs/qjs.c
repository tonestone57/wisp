...
"    globalThis.SecurityPolicyViolationEvent = function SecurityPolicyViolationEvent(type, init) {\n"
"        init = init || {};\n"
...
"            Object.setPrototypeOf(evt, globalThis.Event.prototype);\n"
        "        }\n"
"        return evt;\n"
        "    };\n"
        "    if (typeof window !== 'undefined') {\n"
        "        window.SecurityPolicyViolationEvent = globalThis.SecurityPolicyViolationEvent;\n"
        "    }\n"
        "}\n"
    ...
    const char *svg_polyfill =
        ...
        "        var SVGFilterElement = class SVGFilterElement extends global.SVGElement {};\n"
