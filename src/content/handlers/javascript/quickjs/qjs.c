...
void qjs_inject_dom_polyfills(JSContext *ctx)
{
    ...
    const char *svg_polyfill =
        ...
        "    }\n"
        "    if (typeof Window !== 'undefined' && Window.prototype) {\n"
        "        ['SVGElement', 'SVGGraphicsElement', 'SVGSVGElement', 'SVGForeignObjectElement', 'SVGFEColorMatrixElement', 'SVGFilterElement', 'SVGAnimationElement', 'SVGAnimateElement', 'SVGAnimateTransformElement'].forEach(name => {\n"
