...
void qjs_inject_dom_polyfills(JSContext *ctx)
{
    ...
    const char *html5_polyfills =
        ...
        "}\n"
        "\n"
        "/* ServiceWorkers, CacheStorage & Push Messages */\n"
        "if (typeof globalThis.ServiceWorker === 'undefined') {\n"
        "    globalThis.ServiceWorker = class ServiceWorker extends globalThis.EventTarget {\n"
        "        constructor() {\n"
        "            super();\n"
        "            this.scriptURL = '';\n"
        ...
        "    globalThis.ServiceWorkerRegistration = class ServiceWorkerRegistration extends globalThis.EventTarget {\n"
        "        constructor() {\n"
        "            super();\n"
        "            this.installing = null;\n"
        "            this.waiting = null;\n"
        "            this.active = new globalThis.ServiceWorker();\n"
        "            this.scope = './';\n"
        ...
        "                getState() { return Promise.resolve({ enabled: false, headerValue: '' }); }\n"
        "            };\n"
        "        }\n"
        ...
        "        getNotifications(options) { return Promise.resolve([]); }\n"
        "    };\n"
        "}\n"
        "if (typeof globalThis.ServiceWorkerContainer === 'undefined') {\n"
        "    globalThis.ServiceWorkerContainer = class ServiceWorkerContainer extends globalThis.EventTarget {\n"
        "        constructor() {\n"
        "            super();\n"
        ...
        "        }\n"
        "        get controller() { return new globalThis.ServiceWorker(); }\n"
        "        get ready() { return Promise.resolve(new globalThis.ServiceWorkerRegistration()); }\n"
        "        register(scriptURL, options) { return Promise.resolve(new globalThis.ServiceWorkerRegistration()); }\n"
        "        getRegistration(clientURL) { return Promise.resolve(new globalThis.ServiceWorkerRegistration()); }\n"
        "        getRegistrations() { return Promise.resolve([new globalThis.ServiceWorkerRegistration()]); }\n"
        "        startMessages() {}\n"
        "    };\n"
        "}\n"
        "if (typeof window !== 'undefined') {\n"
        "    window.ServiceWorker = globalThis.ServiceWorker;\n"
        "    window.ServiceWorkerRegistration = globalThis.ServiceWorkerRegistration;\n"
        "    window.ServiceWorkerContainer = globalThis.ServiceWorkerContainer;\n"
        "}\n"
        "if (typeof Window !== 'undefined' && Window.prototype) {\n"
        "    if (!('ServiceWorker' in Window.prototype)) Window.prototype.ServiceWorker = globalThis.ServiceWorker;\n"
        "    if (!('ServiceWorkerRegistration' in Window.prototype)) Window.prototype.ServiceWorkerRegistration = globalThis.ServiceWorkerRegistration;\n"
        "    if (!('ServiceWorkerContainer' in Window.prototype)) Window.prototype.ServiceWorkerContainer = globalThis.ServiceWorkerContainer;\n"
        "}\n"
        "if (globalThis.navigator && !globalThis.navigator.serviceWorker) {\n"
        "    globalThis.navigator.serviceWorker = new globalThis.ServiceWorkerContainer();\n"
        "}\n"
        "\n"
        "/* CacheStorage & Cache */\n"
        ...
        "        }\n"
        "        match(request, options) { return Promise.resolve(undefined); }\n"
        "        matchAll(request, options) { return Promise.resolve([]); }\n"
        "        add(request) { return Promise.resolve(); }\n"
        "        addAll(requests) { return Promise.resolve(); }\n"
        "        put(request, response) {\n"
        "            let key = (typeof request === 'string') ? request : (request && request.url ? request.url : String(request));\n"
        ...
        "        }\n"
        "        keys(request, options) { return Promise.resolve(Array.from(this._entries.keys())); }\n"
        "    };\n"
        "}\n"
        ...
        "        }\n"
        "        open(cacheName) {\n"
        "            let name = String(cacheName);\n"
        "            if (!this._caches.has(name)) {\n"
        "                this._caches.set(name, new globalThis.Cache());\n"
        "            }\n"
        "            return Promise.resolve(this._caches.get(name));\n"
        "        }\n"
        "        has(cacheName) {\n"
        "            return Promise.resolve(this._caches.has(String(cacheName)));\n"
        "        }\n"
        "        delete(cacheName) {\n"
        "            return Promise.resolve(this._caches.delete(String(cacheName)));\n"
        "        }\n"
        "        keys() {\n"
        ...
        "}\n"
        "if (typeof window !== 'undefined') {\n"
        "    window.Cache = globalThis.Cache;\n"
        "    window.CacheStorage = globalThis.CacheStorage;\n"
        "    if (!window.caches) {\n"
        "        window.caches = new globalThis.CacheStorage();\n"
        "    }\n"
        "}\n"
        "if (!globalThis.caches) {\n"
        "    globalThis.caches = (typeof window !== 'undefined' && window.caches) ? window.caches : new globalThis.CacheStorage();\n"
        "}\n"
        "if (typeof Window !== 'undefined' && Window.prototype) {\n"
        "    if (!('Cache' in Window.prototype)) Window.prototype.Cache = globalThis.Cache;\n"
        "    if (!('CacheStorage' in Window.prototype)) Window.prototype.CacheStorage = globalThis.CacheStorage;\n"
        "    if (!('caches' in Window.prototype)) {\n"
        "        Object.defineProperty(Window.prototype, 'caches', {\n"
        "            get() { return globalThis.caches; },\n"
        "            configurable: true,\n"
        "            enumerable: true\n"
        "        });\n"
        "    }\n"
        ...
        "if (globalThis.navigator) {\n"
        "    if (typeof globalThis.navigator.registerProtocolHandler !== 'function') {\n"
        "        globalThis.navigator.registerProtocolHandler = function(scheme, url, title) {};\n"
        "    }\n"
        "    if (typeof globalThis.navigator.unregisterProtocolHandler !== 'function') {\n"
        "        globalThis.navigator.unregisterProtocolHandler = function(scheme, url) {};\n"
        "    }\n"
        "}\n"
        "\n"
    ...
    const char *webgl_polyfill =
        ...
        "                            this._2d_context = {};\n"
        "                        }\n"
        "                        this._2d_context.canvas = this;\n"
        "                    }\n"
        "                    return this._2d_context;\n"
        "                }\n"
        "                if (contextId === 'webgl' || contextId === 'experimental-webgl') {\n"
        "                    if (!this._webgl_context) this._webgl_context = new global.WebGLRenderingContext(this);\n"
        "                    return this._webgl_context;\n"
        "                }\n"
        "                if (contextId === 'webgl2' || contextId === 'experimental-webgl2') {\n"
        "                    if (!this._webgl2_context) this._webgl2_context = new global.WebGL2RenderingContext(this);\n"
        "                    return this._webgl2_context;\n"
        "                }\n"
        "                return null;\n"
        "            }\n"
        "        };\n"
