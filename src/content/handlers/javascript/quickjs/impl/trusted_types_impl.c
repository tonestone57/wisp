...
"\n"
"    // Built-in strict, auto-sanitizing default policy safety net\n"
"    const builtInDefaultPolicy = {\n"
"        createHTML: function(input) {\n"
"            let docStr = String(input);\n"
"            if (isSanitizing) return docStr;\n"
"            isSanitizing = true;\n"
"            try {\n"
...
"                            'script', 'iframe', 'object', 'embed', 'frame', \n"
"                            'frameset', 'meta', 'link', 'style', 'applet', 'base'\n"
"                        ]);\n"
...
"                            } else if ((attrName === 'href' || attrName === 'src' || attrName === 'data' || attrName === 'formaction') &&\n"
...
"            code = code.replace(/\\beval\\s*\\(/gi, 'void(');\n"
"            code = code.replace(/\\bFunction\\s*\\(/gi, 'void(');\n"
"            return code;\n"
"        },\n"
...
"        } else {\n"
"            try {\n"
"                return builtInDefaultPolicy.createHTML(String(value));\n"
"            } catch (e) {}\n"
"        }\n"
...
"        } else {\n"
"            try {\n"
"                return builtInDefaultPolicy.createScript(String(value));\n"
"            } catch (e) {}\n"
"        }\n"
...
"        } else {\n"
"            try {\n"
"                return builtInDefaultPolicy.createScriptURL(String(value));\n"
"            } catch (e) {}\n"
"        }\n"
...
"            if (typeof code === 'string' || globalThis.trustedTypes.isScript(code)) {\n"
...
"                if (typeof body === 'string' || globalThis.trustedTypes.isScript(body)) {\n"
...
"            if (typeof handler === 'string' || globalThis.trustedTypes.isScript(handler)) {\n"
