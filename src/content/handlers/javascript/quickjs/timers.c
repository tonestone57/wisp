...
static JSValue js_clear_timer_internal(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv)
{
...
JSValue js_clearTimeout(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) { return js_clear_timer_internal(ctx, this_val, argc, argv); }
JSValue js_clearInterval(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) { return js_clear_timer_internal(ctx, this_val, argc, argv); }

static JSValue js_setTimeout_internal(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv, bool repeat)
{
    if (argc < 1 || !JS_IsFunction(ctx, argv[0])) return JS_ThrowTypeError(ctx, "Expected function");
    int32_t delay = 0;
...
JSValue js_setTimeout(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) { return js_setTimeout_internal(ctx, this_val, argc, argv, false); }
JSValue js_setInterval(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) { return js_setTimeout_internal(ctx, this_val, argc, argv, true); }
