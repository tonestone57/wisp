...
START_TEST(test_quickjs_webidl_stubs)
{
    ...
    const char *script =
        ...
        "    if (!(document.createElement(\"picture\") instanceof HTMLPictureElement)) throw new Error(\"HTMLPictureElement instanceof failed\");\n"
        "    if (!(document.createElement(\"template\") instanceof HTMLTemplateElement)) throw new Error(\"HTMLTemplateElement instanceof failed\");\n"
        "    if (!(document.createElement(\"data\") instanceof HTMLDataElement)) throw new Error(\"HTMLDataElement instanceof failed\");\n"
        "    if (!(document.createElement(\"time\") instanceof HTMLTimeElement)) throw new Error(\"HTMLTimeElement instanceof failed\");\n"
        "    if (!(document.createElement(\"area\") instanceof HTMLAreaElement)) throw new Error(\"HTMLAreaElement instanceof failed\");\n"
        "    if (!(document.createElement(\"canvas\") instanceof HTMLCanvasElement)) throw new Error(\"HTMLCanvasElement instanceof failed\");\n"
        "    if (!(document.createElement(\"details\") instanceof HTMLDetailsElement)) throw new Error(\"HTMLDetailsElement instanceof failed\");\n"
        "    if (!(document.createElement(\"fieldset\") instanceof HTMLFieldSetElement)) throw new Error(\"HTMLFieldSetElement instanceof failed\");\n"
        "    if (!(document.createElement(\"legend\") instanceof HTMLLegendElement)) throw new Error(\"HTMLLegendElement instanceof failed\");\n"
        "    if (!(document.createElement(\"menu\") instanceof HTMLMenuElement)) throw new Error(\"HTMLMenuElement instanceof failed\");\n"
