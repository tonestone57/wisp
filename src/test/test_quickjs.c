...
START_TEST(test_quickjs_webidl_stubs)
{
    ...
    const char *script =
        ...
        "        // HTML5 Element Prototypes & Constructors Verification\n"
        "        if (!(document.createElement(\"section\") instanceof HTMLElement)) throw new Error(\"HTMLSectionElement instanceof failed\");\n"
        "        if (!(document.createElement(\"nav\") instanceof HTMLElement)) throw new Error(\"HTMLNavElement instanceof failed\");\n"
        "        if (!(document.createElement(\"article\") instanceof HTMLElement)) throw new Error(\"HTMLArticleElement instanceof failed\");\n"
        "        if (!(document.createElement(\"aside\") instanceof HTMLElement)) throw new Error(\"HTMLAsideElement instanceof failed\");\n"
        "        if (!(document.createElement(\"header\") instanceof HTMLElement)) throw new Error(\"HTMLHeaderElement instanceof failed\");\n"
        "        if (!(document.createElement(\"footer\") instanceof HTMLElement)) throw new Error(\"HTMLFooterElement instanceof failed\");\n"
        "        if (!(document.createElement(\"main\") instanceof HTMLElement)) throw new Error(\"HTMLMainElement instanceof failed\");\n"
        "        if (!(document.createElement(\"figure\") instanceof HTMLElement)) throw new Error(\"HTMLFigureElement instanceof failed\");\n"
        "        if (!(document.createElement(\"figcaption\") instanceof HTMLElement)) throw new Error(\"HTMLFigcaptionElement instanceof failed\");\n"
        "        if (!(document.createElement(\"hgroup\") instanceof HTMLElement)) throw new Error(\"HTMLHGroupElement instanceof failed\");\n"
        "        if (!(document.createElement(\"mark\") instanceof HTMLElement)) throw new Error(\"HTMLMarkElement instanceof failed\");\n"
        "        if (!(document.createElement(\"summary\") instanceof HTMLElement)) throw new Error(\"HTMLSummaryElement instanceof failed\");\n"
        "        if (!(document.createElement(\"picture\") instanceof HTMLElement)) throw new Error(\"HTMLPictureElement instanceof failed\");\n"
        "        if (!(document.createElement(\"template\") instanceof HTMLElement)) throw new Error(\"HTMLTemplateElement instanceof failed\");\n"
        "        if (!(document.createElement(\"data\") instanceof HTMLElement)) throw new Error(\"HTMLDataElement instanceof failed\");\n"
        "        if (!(document.createElement(\"time\") instanceof HTMLElement)) throw new Error(\"HTMLTimeElement instanceof failed\");\n"
        "        if (!(document.createElement(\"a\") instanceof HTMLElement)) throw new Error(\"HTMLAnchorElement instanceof failed\");\n"
        "        if (!(document.createElement(\"area\") instanceof HTMLElement)) throw new Error(\"HTMLAreaElement instanceof failed\");\n"
        "        if (!(document.createElement(\"canvas\") instanceof HTMLElement)) throw new Error(\"HTMLCanvasElement instanceof failed\");\n"
        "        if (!(document.createElement(\"details\") instanceof HTMLElement)) throw new Error(\"HTMLDetailsElement instanceof failed\");\n"
        "        if (!(document.createElement(\"fieldset\") instanceof HTMLElement)) throw new Error(\"HTMLFieldSetElement instanceof failed\");\n"
        "        if (!(document.createElement(\"legend\") instanceof HTMLElement)) throw new Error(\"HTMLLegendElement instanceof failed\");\n"
        "        if (!(document.createElement(\"menu\") instanceof HTMLElement)) throw new Error(\"HTMLMenuElement instanceof failed\");\n"
