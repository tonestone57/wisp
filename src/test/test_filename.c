...
START_TEST(filename_initialise_test)
{
    ...
    wisp_mkdir_all(TEMP_FILENAME_PREFIX "/");
...
START_TEST(filename_flush_disk_test)
{
    ...
    wisp_mkdir_all(TEMP_FILENAME_PREFIX "/03/00/00/");
    wisp_mkdir_all(TEMP_FILENAME_PREFIX "/03/00/00/unexpected_dir/");
    wisp_mkdir_all(TEMP_FILENAME_PREFIX "/99/");
