...
|---|---|---|---|---|
| **Tier 1: Full Spec** | ✅ Functional | Complete C logic (e.g., `putImageData_0`, `getElementById`, `addEventListener`). | Keep & Test | **1108** |
| **Tier 2: Safe No-Ops** | ⚠️ Partial | Valid C function returning `JS_UNDEFINED` or `JS_FALSE` to prevent JS execution crashes on non-essential/minor APIs. | Upgrade to Tier 1 | **1873** |
...
- [x] Run Python-based quantitative audit over the 2,995 total implementation symbols
