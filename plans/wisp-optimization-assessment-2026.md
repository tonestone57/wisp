...
- **WebIDL & Web API Parity**: 3,008+ manual C symbol overrides (`wisp_*_impl`) connecting WebIDL interfaces directly to LibDOM and virtual SHM DOM nodes. 100% score (32/32) in HTML5Test `scripting`, `security` (32/32), and `offline` (13/13) subcategories with 559/588 overall score.
